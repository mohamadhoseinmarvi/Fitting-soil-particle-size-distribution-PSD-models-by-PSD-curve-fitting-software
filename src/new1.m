...
xlabel('Wavelength (m)'); ylabel('PSD');
title('Wavelength PSD'); colorbar; box on;
...
title('Wavelength PSD');
  ...
  set(gca,'Fontsize',12);
  xlabel('Wavelength, m','Fontsize',16); ylabel('PSD','Fontsize',16);
  title('Wavelength PSD');
  set(gca,'XDir','reverse'); grid on;
  hold on
  ...
  h = colorbar; title(h,'Wavelength PSD');
  set(gca,'Fontsize',14)
  xlabel('Wavelength (km)','Fontsize',16)
  ylabel('PSD','Fontsize',16)
  title('Wavelength PSD','Fontsize',16);
